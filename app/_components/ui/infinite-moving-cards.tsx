  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border-2 border-b flex-shrink-0 border-border-foreground px-8 py-4 md:w-[450px]"
            key={idx}
          >
            <blockquote>
              <div
              ...
              <div className="relative z-20 flex items-center mt-2 w-full">
                {" "}
